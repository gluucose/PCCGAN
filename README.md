...
Before training, prepare your data in the dataset folder. Note that, in the model folder,
...
The training code is for PMC<sup>2</sup>-GAN with mutli-modality inputs. To train the model, you can run:
```bash
python train.py
```
